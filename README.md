...
I am a **backend-oriented Full Stack Developer** focused on building **scalable, maintainable, and cloud-ready applications**.

My main expertise is **Java with Spring Boot**, complemented by **Python and Node.js** for automation, integrations, and backend services. I actively work with **AWS, Docker, and Linux-based environments**, applying DevOps principles to real-world projects.

Frontend technologies are part of my toolkit, but I primarily use them as **support to backend systems and product delivery**.
...
I’m open to opportunities and collaborations focused on **backend development, cloud infrastructure, and automation**.
...
[![Portfolio](https://img.shields.io/badge/Portfolio-000?style=for-the-badge\&logo=briefcase\&logoColor=white)](https://www.luizguimaraesdev.com.br/)

---

![Typing](https://readme-typing-svg.herokuapp.com?font=JetBrains+Mono\&weight=600\&size=18\&duration=3000\&pause=1000\&color=00FF00\&center=true\&vCenter=true\&random=false\&width=480\&lines=Technology+Moves+The+World)
